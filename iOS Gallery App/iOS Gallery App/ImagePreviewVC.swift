...
class ImagePreviewVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout  {
    ...
    override func viewDidLoad()
    {
        ...
        myCollectionView.register(FullScreenImage.self, forCellWithReuseIdentifier: "Cell")
    ...
    {
        let cell=collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! FullScreenImage
...
class FullScreenImage: UICollectionViewCell, UIScrollViewDelegate
{
